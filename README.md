...
В планах напольнить фронтенд для реализации полноценного сайта(в настоящее время создан фронтенд на Angular,
настроена связь между бэкендом и фронтендем, но не настроен на отображение функционала),
развернуть проект на удаленном серве в аркестре контейнеров.
